...
<div class ="container">
	<div class ="row">
		...
		<div class="col-sm-4" >
			<h4 style="font-family: 'Rammetto One', cursive;font-size:80px">Welcome</h4>
			 <div  style="text-align:center;background-attachment:fixed;border:2px solid;padding:20px;box-shadow:10px 5px 10px red;border-radius:20px" >
			 	<form action="log_check.php" method="POST">
			 		<input type="number" name="id" style="padding:10px;border:1px solid;width:250px;" placeholder="Student Id" ><br><br>
					<input type="password" name="pass" style="padding:10px;border:1px solid;width:250px;" placeholder="password" ><br><br>
					<input type="submit"  style="padding:10px;border-radius:3px solid groove;width:200px;" value="login" ><br><br>
			 	</form>
					<a href ="register.php" style="color:white">Register yourself here </a>
		</div>
	</div>
		<div class="col-sm-4">
		</div>
