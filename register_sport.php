...
<div class ="container">
	<div class ="row">
		...
		<div class="col-sm-4" >
			<h4 style="font-family: 'Rammetto One', cursive;font-size:80px">SPORTY</h4>
			 <div  style="text-align:center;background-attachment:fixed;border:2px solid;padding:20px;box-shadow:10px 5px 10px red;border-radius:20px" >
			 	<form method="POST" action="check_sport.php">
			 		<input type="integer" name="id" style="padding:10px;border:1px solid;width:250px;" placeholder="College id" ><br><br>
			 		<input type="text" name="sport" style="padding:10px;border:1px solid;width:250px;" placeholder="Sport" ><br><br>
